...
static cocos2d::Size resolutionSize = cocos2d::Size(640, 1136);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    (CC_TARGET_PLATFORM == CC_PLATFORM_LINUX)
        glview = GLViewImpl::createWithRect(
            "CollisionSample", Rect(0, 0, designResolutionSize.width,
                                    designResolutionSize.height));
#else
        glview = GLViewImpl::create("CollisionSample");
#endif
    ...
    director->setContentScaleFactor(
        MIN(resolutionSize.height / designResolutionSize.height,
            resolutionSize.width / designResolutionSize.width));
    /*
